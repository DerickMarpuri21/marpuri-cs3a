...
asym_encrypt_button = st.button("Encrypt (RSA)")
asym_decrypt_button = st.button("Decrypt (RSA)")

if asym_encrypt_button or asym_decrypt_button:
    try:
...
hash_text_button = st.button("Hash Text")
hash_file_button = st.button("Hash File")
